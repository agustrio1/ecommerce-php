<?php $this->layout('layouts.app', ['title' => 'Kirim Ulang Verifikasi']) ?>

<?php $this->section('content') ?>

<div class="min-h-screen flex items-center justify-center px-4">
    <div class="w-full max-w-md bg-white rounded-xl shadow-md p-8">
        <h1 class="text-2xl font-bold text-gray-900 mb-1">Kirim Ulang Verifikasi</h1>
        <p class="text-gray-500 text-sm mb-6">Masukkan email Anda untuk menerima link verifikasi baru</p>

        <form method="POST" action="/resend-verification" class="space-y-4">
            <?= csrf_field() ?>
